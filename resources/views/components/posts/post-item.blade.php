@props(['post'])
<article {{$attributes->merge(['class'=>'[&:not(:last-child)]:border-b border-gray-900 dark:border-gray-100 pb-10'])}} >
    <div class="article-body grid grid-cols-12 gap-3 mt-5 items-start">
        ...
        <div class="col-span-8">
            ...
            <p class="mt-2 text-base text-gray-900 dark:text-gray-200 font-light">
                {{$post->getExcerpt()}}
            </p>s
            <div class="article-actions-bar mt-6 flex items-center justify-between">
                <div class="flex gap-x-2">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-900 dark:text-gray-200 text-sm">{{$post->getReadingTime()}} {{__('blog.min_read')}}</span>
                    </div>
                </div>
                <div>
