<x-app-layout>
    <article class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 w-full" style="max-width:700px">
            ...
            <div class="mt-2 flex justify-between items-center">
                <div class="flex py-5 text-base items-center">
                    <img class="w-10 h-10 rounded-full mr-3" src=""
                         alt="avatar">
                    <span class="mr-1 text-gray-900 dark:text-gray-200">MN</span>
            ...
            <div class="mt-10 comments-box border-t border-gray-100 pt-10">
                ...
                <textarea
                    class="w-full rounded-lg p-4 bg-gray-50 focus:outline-none text-sm text-gray-900 dark:text-gray-200 border-gray-200 placeholder:text-gray-400"
                ...
                <div class="user-comments px-3 py-2 mt-5">
                    <div class="comment [&:not(:last-child)]:border-b border-gray-100 py-5">
                        <div class="user-meta flex mb-4 text-sm items-center">
                            ...
                            <span class="mr-1 text-gray-900 dark:text-gray-200">user name</span>
                            <span class="text-gray-900 dark:text-gray-200">. 15 days ago</span>
                        </div>
                        <div class="text-justify text-gray-900 dark:text-gray-200  text-sm">
                            comment content
                        </div>
                    </div>
